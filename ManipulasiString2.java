...
public class ManipulasiString2{
    static Character[] arrHurufVokal = {'a','A','i','I','u','U','e','E','o','O'};
    static ArrayList<Character> arrListHurufVokal = new ArrayList<Character>(Arrays.asList(arrHurufVokal));
    ...
    public static void main(String[] args) {
        ...
        while(ulangA){
            ...
            System.out.println("Hasil fungsi hapusHurufKonsonan1: " + hapusHurufKonsonan1(teks));
            System.out.println("Hasil fungsi hapusHurufKonsonan2: " + hapusHurufKonsonan2(teks));
